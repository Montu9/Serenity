    ...
    return (
        <div className="h-full w-full min-h-screen min-w-screen">
            <Card className="container relative px-8 py-12 lg:my-12">
                ...
                <p className="leading-7 [&:not(:first-child)]:mt-6">Last updated: January 07, 2024</p>
                ...
                <ul className="my-6 ml-6 list-disc [&>li]:mt-2">
                    ...
                    <li>
                        <p className="leading-7 [&:not(:first-child)]:mt-6">
                            ...
                            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Serenity.
                        </p>
                    </li>
                    <li>
                        <p className="leading-7 [&:not(:first-child)]:mt-6">
                    ...
                    <li>
                        <p className="leading-7 [&:not(:first-child)]:mt-6">
                            <strong>Website</strong> refers to Serenity, accessible from{" "}
                            <a href="https://serenityms.xyz" rel="external nofollow noopener" target="_blank">
                                https://serenityms.xyz
                            </a>
                        </p>
                    </li>
                    <li>
                ...
                <h3 className="mt-8 scroll-m-20 text-2xl font-semibold tracking-tight">Types of Data Collected</h3>
                <h4>Personal Data</h4>
                <p className="leading-7 [&:not(:first-child)]:mt-6">
                ...
                <h3 className="mt-8 scroll-m-20 text-2xl font-semibold tracking-tight">Use of Your Personal Data</h3>
                <p className="leading-7 [&:not(:first-child)]:mt-6">
                ...
                <h3 className="mt-8 scroll-m-20 text-2xl font-semibold tracking-tight">Delete Your Personal Data</h3>
                <p className="leading-7 [&:not(:first-child)]:mt-6">
                ...
                <ul className="my-6 ml-6 list-disc [&>li]:mt-2">
                    <li>By email: noreply.serenityms@gmail.com</li>
                </ul>
            </Card>
        </div>
    );
